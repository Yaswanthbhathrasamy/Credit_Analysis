...
function LeafLogo({ className = "h-8 w-8" }) {
  return (
    <svg viewBox="0 0 64 64" className={className} fill="none" xmlns="http://www.w3.org/2000/svg">
      ...
      <line x1="32" y1="18" x2="22" y2="30" stroke="#67e8f9" strokeWidth="1" opacity="0.7"/>
      <line x1="32" y1="18" x2="42" y2="30" stroke="#67e8f9" strokeWidth="1" opacity="0.7"/>
      <line x1="22" y1="30" x2="27" y2="42" stroke="#67e8f9" strokeWidth="1" opacity="0.7"/>
      <line x1="42" y1="30" x2="37" y2="42" stroke="#67e8f9" strokeWidth="1" opacity="0.7"/>
      <line x1="22" y1="30" x2="42" y2="30" stroke="#67e8f9" strokeWidth="0.8" opacity="0.5"/>
      <line x1="27" y1="42" x2="37" y2="42" stroke="#67e8f9" strokeWidth="0.8" opacity="0.5"/>
      <line x1="27" y1="42" x2="32" y2="52" stroke="#67e8f9" strokeWidth="1" opacity="0.7"/>
      <line x1="37" y1="42" x2="32" y2="52" stroke="#67e8f9" strokeWidth="1" opacity="0.7"/>
    </svg>
  );
}
...
export default function Layout({ children }) {
  ...
  return (
    <div className="min-h-screen bg-navy-50 flex flex-col">
      ...
      {/* Main Navigation */}
      <nav className="gradient-bg text-white shadow-lg sticky top-0 z-50 border-b border-teal-900/30">
          ...
          <div className="flex items-center justify-between h-16">
            ...
            <Link to="/" className="flex items-center space-x-3 group">
              ...
              <div className="flex flex-col">
                <span className="text-lg font-bold tracking-tight leading-none bg-gradient-to-r from-teal-300 to-emerald-300 bg-clip-text text-transparent">
                  Intelli-Credit
                </span>
                <span className="text-[10px] text-teal-400/70 font-medium tracking-wider uppercase">
                  AI Credit Platform
                </span>
              </div>
            </Link>
              ...
              {NAV_LINKS.map(({ to, label, icon: Icon }) => (
                <Link
                  ...
                  className={`flex items-center space-x-1.5 px-3 py-2 rounded-lg text-sm font-medium transition-all duration-200 ${
                    isActive(to)
                      ? 'bg-teal-500/20 text-teal-200 shadow-sm ring-1 ring-teal-500/30'
        ...
        {/* Mobile Nav */}
        {mobileOpen && (
          <div className="md:hidden border-t border-teal-800/30 pb-3">
            {NAV_LINKS.map(({ to, label, icon: Icon }) => (
              <Link
                key={to}
                to={to}
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-3">
          <div className="flex flex-col sm:flex-row items-center justify-between gap-2">
            <div className="flex items-center space-x-2">
              ...
              <span className="text-teal-300 text-sm font-semibold">Intelli-Credit</span>
            ...
            <div className="flex items-center space-x-4 text-xs">
              ...
              <Link to="/analyzer" className="hover:text-teal-300 transition">Analyzer</Link>
              <Link to="/team" className="hover:text-teal-300 transition">Team</Link>
